...
function main(workingDirectory, additionalOptions, callbacks) {
    ...
    try {
        ...
        var relativeWorkingDirectory = path_1.relative(gitDirectoryParent_1, workingDirectory);
        var modifiedFilenames = git_utils_1.getModifiedFilenames(gitDirectoryParent_1, options_1.base, options_1.head)
            ...
            .filter(utils_1.generateFilesWhitelistPredicate(options_1.filesWhitelist, relativeWorkingDirectory))
